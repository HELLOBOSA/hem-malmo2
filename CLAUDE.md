# Hemreform Malmö — Site Maintenance Guide

## Overview

Static site for **Hemreform**, a renovation & carpentry company in Malmö, Sweden.
Hosted on GitHub Pages, deployed from the `main` branch.
Domain: `malmo.hemreform.se`.
...
- `blogg/badrumsrenovering-malmo-pris/index.html`
- `blogg/badrumsrenovering-bostadsratt-malmo/index.html`
- `blogg/bygglov-anmalan-renovering-malmo/index.html`
- `blogg/koksrenovering-bostadsratt-malmo/index.html`
- `blogg/koksrenovering-malmo-pris/index.html`
- `blogg/lagenhetsrenovering-malmo/index.html`
- `blogg/sekelskifteslagenhet-renovering-malmo/index.html`
- `blogg/specialsnickeri-malmo/index.html`
- `blogg/totalrenovering-malmo-pris/index.html`
- `blogg/badrumsrenovering-malmo-pris-planering/index.html`
- `blogg/koksrenovering-malmo-guide/index.html`
- `blogg/totalrenovering-lagenhet-malmo/index.html`
- `blogg/bygglov-renovering-malmo/index.html`
- `blogg/rot-avdrag-malmo-2026/index.html`
- `blogg/renovera-bostadsratt-malmo/index.html`
- `blogg/tips-anlita-hantverkare-malmo/index.html`
- `blogg/maleri-tapetsering-malmo/index.html`
...
1. Create a new directory under `blogg/` using a descriptive Swedish slug:
   e.g., `blogg/golvlaggning-malmo-tips/`
...
Tracking ID: `G-YVB0GJQP9G` — installed on all pages via Google Tag Manager (gtag.js).
